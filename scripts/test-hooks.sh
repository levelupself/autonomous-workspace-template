...
assert_blocked "git push origin main"     "$(bash_input 'git push origin main')"              "$FIREWALL"
assert_blocked "git push origin master"   "$(bash_input 'git push origin master')"            "$FIREWALL"
